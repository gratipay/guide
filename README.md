...
The important thing to remember about an open organization is that it is still an *organization*, a term we'll use to mean an economic unit larger than an individual. Whether business, charity, or government, organizations take in money, and produce value in the world. Open organizations are no different in that regard, and they are subject to the same market and regulatory forces as any other organization. They have to tell a better story about a better product for a better price in order to succeed, and therefore much of the advice that applies to *any* organization translates more or less directly to an open organization.
