...
The most important thing to understand about an open organization is that it is fundamentally an *organization*, a term we use loosely to mean an economic unit larger than an individual. Whether business, charity, or government, organizations take in money, and produce value in the world. Open organizations are no different in that regard. Open organizations are still subject to the same market and regulatory forces as any other organization. We still have to provide more value for a lower price if we want to succeed.
